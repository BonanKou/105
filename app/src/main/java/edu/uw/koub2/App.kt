...
//代表一个event， 提供地点(LatLng)，日期(date)，时间（date），以及description（String）。
class Event(location: LatLng, var topic:String, var date:Date, var time:Date, var description:String ="Please add one later.") {
    override fun hashCode(): Int {
        return (super.hashCode()+time.day+time.hours+time.minutes)
    }
}
